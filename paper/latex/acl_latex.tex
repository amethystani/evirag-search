...
\fill[gray!11] (9.2, 0.1) circle (3.25);
\draw[gray!36, line width=0.55pt] (9.2, 0.1) circle (3.25);
\node[font=\small\itshape, text=blue!58] at (9.2, -3.75)
  {Evidence Hyperspace};

%%── Graph nodes ──────────────────────────────────────────────────────────
\node[qnode] (qn)  at (6.30, 0.15) {};   %% query entry (green)
\node[lnode] (v1)  at (9.35, 3.05) {};   %% Grade 7-12 gain
\node[lnode] (v2)  at (12.10, 0.40) {};  %% No SES effect
\node[lnode] (v3)  at (8.10, -2.75) {};  %% Wellbeing harm

%%── Slanted floating labels ──────────────────────────────────────────────
\node[font=\small\bfseries, text=orange!80!red, rotate=30]
  at (8.8, 3.80)  {Grade 7--12 gain ($d{\approx}0.30$)};
\node[font=\small\bfseries, text=red!65!black, rotate=-8]
  at (13.65, 1.05) {No effect (SES-adj.)};
\node[font=\small\bfseries, text=teal!62!black, rotate=15]
  at (7.35, -3.52) {Wellbeing harm};
\node[font=\footnotesize\bfseries, text=green!55!black, above=3pt of qn]
  {Query};

%%── Edge labels inside circle ────────────────────────────────────────────
\node[elab] at (10.45, 2.05) {Contradicts};
\node[elab] at (10.85, -1.35) {Supersedes};
...
\draw[cpath] (v2)        to[bend right=15] (v1);

%%── Answer box (right, yellow) ───────────────────────────────────────────
\node[abox] (ans) at (16.9, 0.3) {%
...
%%── Arrow: v1 → answer box ───────────────────────────────────────────────
\draw[apath] (v1.east) to[out=0, in=145] (ans.north west);

%%── Bottom legend ────────────────────────────────────────────────────────
\draw[epath, line width=1.3pt] (3.6, -5.15) -- (5.4, -5.15);
\node[right, font=\small, text=gray!60] at (5.4, -5.15)
  {$r^\mathrm{std}$\;:\;Standard RAG\;(single-view collapse)};
\draw[cpath, line width=1.3pt] (12.3, -5.15) -- (14.1, -5.15);
\node[right, font=\small, text=gray!60] at (14.1, -5.15)
